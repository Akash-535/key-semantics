...
const SemanticsInput = () => {
    ...
    return (
        <div className='bg-blue-dark py-24 flex flex-col justify-center items-center max-xl:px-5 relative'>
            <img className='absolute top-0 left-28 max-xl:max-w-24 max-xl:left-16 max-lg:hidden' src="./assets/images/input-left-ellips.webp" alt="ellips" />
            <img className='absolute bottom-0 right-28 max-xl:max-w-24 max-xl:right-16 max-lg:hidden' src="./assets/images/input-right-ellips.webp" alt="ellips" />
